...
{
    public function __construct($parameterName, $index, $value, $expectedType, \Exception $previous = null, \Icecave\Skew\Entities\TypeCheck\TypeInspector $typeInspector = null)
    {
        if (null === $typeInspector) {
            $typeInspector = new \Icecave\Skew\Entities\TypeCheck\TypeInspector();
        }
