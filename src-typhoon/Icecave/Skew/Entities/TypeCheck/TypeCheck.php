...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\Skew\\Entities\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\Skew\\Entities\\TypeCheck'), true);
    }
