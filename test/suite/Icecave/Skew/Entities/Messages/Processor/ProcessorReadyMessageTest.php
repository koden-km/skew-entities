...
class ProcessorReadyMessageTest extends PHPUnit_Framework_TestCase
{
    public function setUp()
    {
        $this->message = new ProcessorReadyMessage;
    }
    ...
    {
        $this->assertSame('processor.ready', $this->message->type());
    }
    ...
    public function testAccept()
    {
        ...
        Phake::when($visitor)
            ->visitProcessorReadyMessage($this->message)
            ->thenReturn(123);
