...
class JobRequestMessageTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testInterfaces()
    {
        ...
        $this->assertInstanceOf('Icecave\Skew\Entities\ClientMessageInterface', $this->message);

        $this->assertNotInstanceOf('Icecave\Skew\Entities\ProcessorMessageInterface', $this->message);
        $this->assertNotInstanceOf('Icecave\Skew\Entities\DaemonToClientMessageInterface', $this->message);
